...
namespace JN.RabbitMQClient.Interfaces
{
    public interface IRabbitMqSenderService
    {
        ...
        void Send(string message, bool createQueue);
        ...
        /// <param name="encodingName">Message encoding name.</param>
        /// <param name="createQueue">Try to create the queue (when sending to a queue) - optional.</param>
        void Send(string message, string exchangeName, string routingKeyOrQueueName, string encodingName, bool createQueue);
        ...
        /// <param name="encoding">Message encoding.</param>
        /// <param name="createQueue">Try to create the queue (when sending to a queue) - optional.</param>
        void Send(string message, string exchangeName, string routingKeyOrQueueName, Encoding encoding, bool createQueue);
