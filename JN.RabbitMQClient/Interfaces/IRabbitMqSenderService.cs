...
namespace JN.RabbitMQClient.Interfaces
{
    public interface IRabbitMqSenderService
    {
        ...
        Result<QueueInfo> Send(string message, IMessageProperties properties = null);
        ...
        /// <param name="properties">Message properties (optional)</param>
        Result<QueueInfo> Send(string message, bool createQueue, IMessageProperties properties = null);
        ...
        /// <param name="properties">Message properties (optional)</param>
        Result<QueueInfo> Send(string message, string exchangeName, string routingKeyOrQueueName,
        ...
        /// <param name="properties">Message properties (optional)</param>
        Result<QueueInfo> Send(string message, string exchangeName, string routingKeyOrQueueName, bool createQueue,
            IMessageProperties properties = null);
        ...
        /// <param name="properties">Message properties (optional)</param>
        Result<QueueInfo> Send(string message, string exchangeName, string routingKeyOrQueueName, string encodingName,
            IMessageProperties properties = null);
        ...
        /// <param name="properties">Message properties (optional)</param>
        Result<QueueInfo> Send(string message, string exchangeName, string routingKeyOrQueueName, Encoding encoding,
            IMessageProperties properties = null);
